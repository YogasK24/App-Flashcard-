  ...
  return (
    ...
    >
      <div className="bg-[#2B2930] rounded-2xl p-6 w-full max-w-sm shadow-xl animate-fade-in-content">
        <h2 className="text-xl font-bold text-white mb-6">Tambah Kartu Baru</h2>
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="card-front" className="block text-sm font-medium text-[#C8C5CA] mb-2">
              Depan
            </label>
            <textarea
              id="card-front"
          ...
          <div className="mb-6">
            <label htmlFor="card-back" className="block text-sm font-medium text-[#C8C5CA] mb-2">
              Belakang
            </label>
             <textarea
              id="card-back"
