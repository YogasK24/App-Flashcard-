...
const ConfirmDeleteCardModal: React.FC<ConfirmDeleteCardModalProps> = ({ cardFront, onClose, onConfirm }) => {
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 id="delete-card-modal-title" className="text-xl font-bold text-gray-900 dark:text-white mb-4">Hapus Kartu</h2>
        <p id="delete-card-modal-description" className="text-gray-600 dark:text-[#C8C5CA] mb-6">
